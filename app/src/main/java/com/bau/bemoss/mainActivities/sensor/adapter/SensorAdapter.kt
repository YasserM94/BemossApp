package com.bau.bemoss.mainActivities.sensor.adapter
...
import com.bau.bemoss.mainActivities.sensor.SensorDeviceActivity
import com.bau.bemoss.models.SensorModel

class SensorAdapter(private val list: ArrayList<SensorModel>)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val item: SensorModel = list.get(index = position)
        holder.bind(item)

        holder.itemView.setOnClickListener {
            intent(SensorDeviceActivity::class.java, item.id)
        }
